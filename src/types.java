...
public class types {
    public enum lexer_token {
        // unary operators
        DIRECTIVE, COMMENT, ABSOLUTE_VALUE, NOT, UNASSIGNMENT, LABEL,

        // binary operators
        ASSIGNMENT, WHILE, EQUAL_TO, LESS_THAN, GREATER_THAN, LESS_THAN_EQUAL_TO, GREATER_THAN_EQUAL_TO, NOT_EQUAL_TO, OR, BITSHIFT_LEFT, BITSHIFT_RIGHT, BITROTATE_LEFT, BITROTATE_RIGHT, DIVIDE, STRUCTURE_REFERNCE, STRUCTURE_DEREFERNCE, NAMESPACE_RESOLUTION, LIST_SEPARATOR, MODULO, ELVIS,

        // binary and unary operators
        AMPERSAND, ASTERISK, PLUS, MINUS, CARET,

        // pair operators
        TERNARY_PART1, FUNCTION_DEF, FUNCTION_END, PAREN_LEFT, PAREN_RIGHT, SQUARE_BRACKET_LEFT, SQUARE_BRACKET_RIGHT, DOUBLE_QUOTE, QUOTE, CURLY_LEFT, CURLY_RIGHT,

        // pair and binary and unary operators
        COLON,

        // generic
        STRING, CHAR, DECIMAL_NUMBER, OCTAL_NUMBER, BINARY_NUMBER, SENARY_NUMBER, KEYWORD, TEXT, TYPE, INTRINSIC, 
